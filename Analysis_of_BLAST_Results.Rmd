...
# pump the results to a new data set
...
joined_blast_data_metadata %>%
  ...
  theme(axis.text.x = element_text(angle = 90,
                                   hjust = 1)) +
   ggtitle("Most frquently found species count in each sex and each locations") +
  xlab("species name") +
  ylab("number found") +
  facet_grid(env_material_s ~ .)
```
